...
9. [ ] **Backup-format evaluation (SPEC-016)** — assess `rmoney-data-v4 → v5` for the new transaction types/fields **and** the new `cryptoProfiles` collection; include `cryptoProfiles` in export/import; update RELEASE.md *Data compatibility* table.
