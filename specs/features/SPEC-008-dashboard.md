...
- [x] **Due-pending rows are clickable too** *(bug fix 2026-07-09)*: opening the occurrence dialog in pending mode (adjust date/amount, skip, or confirm); the inline Confirm button still books the planned values directly
