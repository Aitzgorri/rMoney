...
- [x] Each scheduled row has a **↻ occurrence button** opening the one-time occurrence dialog (adjust date/amount, skip, record now — Phase 64, SPEC-012), and rows whose next occurrence is adjusted show an amber **↻ marker** with the effective date *(Phase 64b)*
